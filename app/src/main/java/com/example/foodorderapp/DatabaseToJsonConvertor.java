...
public class DatabaseToJsonConvertor {
    // Json exception handles errors if something goes Wrong while converting the databse to Json format.
    ...
    public static File convertDatabaseToJson(Context context, String databaseName) throws JSONException, IOException {
        ...
        Cursor cursor = null;
        // JsonArray will store the data in the tables in Json Format.
        ...
        try {
            ...
            if (cursor.moveToFirst()){
                ...
                do{
                    // retrieves the table Nmae from the first column of the cursor.
                    ...
                    if (!tableName.equals("android_metadata") && !tableName.equals("sqlite_sequence")) {
                        ...
                        while (tableCursor.moveToNext()){
                            ...
                            // putting eac row in the tableArray
